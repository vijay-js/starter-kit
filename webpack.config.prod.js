...
export default {
  ...
  output: {
	...
	plugins: [
		...
		//Use CommonsChunkPlugin to create a spearate bundle
    ...
    new HtmlWebpackPlugin({
      ...
      inject: true,
			//Any properties defined here are available in index.html
			//using htmlWebpackPlugin.options.varName
			trackJSToken : 'sdfhsdfoigsdig'
    }),
		//Eliminate duplicate packages while generating bundle
